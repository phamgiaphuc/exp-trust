...
const AddressAndSearchBar = () => {
  return (
    <div className='flex bg-white   flex-row items-center  w-full justify-between rounded-xl '>
      <div className='flex flex-col w-5/12 justify-between items-center  rounded-xl'>
      ...
      <div className=' h-11 flex items-center justify-end w-5/12 rounded-lg border-[1px] border-[#BABABA]'>
